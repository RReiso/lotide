...
const eqObjects = function(object1, object2) {
  ...
  for (const key in object1) {
    ...
    if (isBothObjects) {
      return eqObjects(obj1Val, obj2Val);
    }
...
console.log(eqObjects({ a: { y: {m: 3}, z: 1 }, b: 2 }, { a: { y: {m: 3}, z: 1 }, b: 2 })); //true/
console.log(eqObjects({ a: { y: {m: ["2", 3, 4]}, z: 1 }, b: 2 }, { a: { y: {m: ["2", 3, 4]}, z: 1 }, b: 2 })); //true/
